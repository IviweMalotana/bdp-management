...
namespace BDP.API.Migrations
{
    ...
    [Migration("20260622000000_AddSupplierFields")]
    partial class AddSupplierFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BDP.API.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("B2BClientId")
                        .HasColumnType("integer");

                    b.Property<string>("B2BStatus")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountType = "B2C",
                            B2BStatus = "NA",
                            ConcurrencyStamp = "9492379d-a9e8-47b5-bdf5-c4388ebfb644",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELQR7n5yZs8Imdiw5rESzhaE0DACs1jWj06T2aLbvCK5fvsddjDR5J9rppigK1jXVw==",
            ...
            modelBuilder.Entity("BDP.API.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BDP.API.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("CustomisationNotes")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BDP.API.Models.CartItemArtwork", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BDP.API.Models.CurrencyRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("RateFromZAR")
                        .HasPrecision(18, 8)
            ...
            modelBuilder.Entity("BDP.API.Models.CustomerAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BDP.API.Models.CustomisationSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("PricePerUnitZAR")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");
                    ...
                    b.ToTable("CustomisationSettings");
                });
            ...
            modelBuilder.Entity("BDP.API.Models.OrderItemArtwork", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BDP.API.Models.ProductVariant", b =>
                {
                    ...
                    b.Property<string>("BaseBodyColor")
                        .HasColumnType("text");

                    b.Property<string>("BaseBodyFinish")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ColorVariantName")
                        .HasColumnType("text");

                    b.Property<string>("ImageDriveLink")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("LidCapColor")
                        .HasColumnType("text");

                    b.Property<string>("LidCapFinish")
                        .HasColumnType("text");

                    b.Property<string>("LidCapMaterial")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("Source1688Url")
                        .HasColumnType("text");

                    b.Property<string>("SpecificationSize")
                        .HasColumnType("text");

                    b.Property<int>("SupplierMoq")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BDP.API.Models.ShippingRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("DutyRatePercent")
                        .HasPrecision(8, 2)
                    ...
                    b.Property<decimal>("ExchangeRateCNYToZAR")
                        .HasPrecision(10, 4)
                        .HasColumnType("numeric(10,4)");
                    ...
                    b.Property<decimal>("MinimumChargeZAR")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.HasIndex("Country", "ShippingType")
                        .IsUnique();
            ...
            modelBuilder.Entity("BDP.API.Models.CartItem", b =>
                {
                    b.HasOne("BDP.API.Models.Cart", "Cart")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("BDP.API.Models.CartItemArtwork", b =>
                {
                    b.HasOne("BDP.API.Models.CartItem", "CartItem")
                        .WithMany("Artworks")
            ...
            modelBuilder.Entity("BDP.API.Models.OrderItemArtwork", b =>
                {
                    b.HasOne("BDP.API.Models.OrderItem", "OrderItem")
                        .WithMany()
